...
load("Data/Arizona_Data_LONG_2017.Rdata")
...
AZ_CONFIG_2017 <- c(ELA_2017.config, MATHEMATICS_2017.config, ALGEBRA_I_2017.config, GEOMETRY_2017.config, ALGEBRA_II_2017.config)
